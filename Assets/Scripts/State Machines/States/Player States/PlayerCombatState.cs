...
public class PlayerCombatState : PlayerBaseState
{
	...
	public PlayerCombatState(PlayerStateMachine playerStateMachine) : base(playerStateMachine) { }
	...
	public override void UpdateState()
	{
		...
		stateMachine.superSpeedController.Dash(canDash());
	...
	private void Move()
	{
		...
		float targetSpeed = GetMoveSpeed();
	...
	private float GetMoveSpeed()
    {
		if (canDash())
        {
			return stateMachine.superSpeed;
        }
		else if (stateMachine.aimController.enabled)
        {
			return stateMachine.defaultMoveSpeed;
        }
        else
        {
			return stateMachine.inCombatMoveSpeed;
        }
	}
